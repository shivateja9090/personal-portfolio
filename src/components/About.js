...
export default function About() {
    ...
    return (
        ...
        <h2  data-aos="fade-down" style={{color:'#2980b9',fontSize:'20px',fontWeight:'bold',paddingBottom:'10px',lineHeight:'1.5em',textAlign:'center'}}>I'am Shiva Teja</h2>   
        <p data-aos="fade-down" style={{lineHeight:'1.6em',wordSpacing:'0.3em',wordWrap:'break-word',textAlign:'justify'}}>I am an engineering student  currently pursuing my degree from Aurora’s Technological & Research Institute,and an aspiring full stack MERN Developer . Some of my hobbies includes option chain analysis . I am looking for freelancing and internship opportunities where i can showcase my skills via collaborative work .    
        </p>    
        </div>
        </div>
        </div>
       ...
       <div className="d-flex justify-content-around align-items-center" >
        ...
        <h5 style={{fontSize:"15px",color:'#2980b9',textAlign:'center'}} >martinet high school</h5>   
        </div>
        <div>
        ...
        <h5 style={{fontSize:"15px",color:'#2980b9',textAlign:'center'}}>2004 ~ 2016</h5>   
      </div>   
       </div>
        </Card>
        ...
        <h5 style={{fontSize:"15px",color:'#2980b9',textAlign:'center'}} >10th Standard ~ ( 77% )</h5>   
        <h5 style={{fontSize:"15px",color:'#2980b9',textAlign:'center'}} >(10+2)th Standard  ~ ( 83% ) </h5>   

        </div>
        <div>
        <h5 className="d-flex mb-2 " style={{fontSize:"17px",color:'#2980b9'}} ><div><FontAwesomeIcon className="mr-2" icon="calendar" /></div>TimeLine</h5>
        <h5 style={{fontSize:"15px",color:'#2980b9',textAlign:'center'}}>2016</h5>   
        <h5 style={{fontSize:"15px",color:'#2980b9',textAlign:'center'}}>2018</h5>   
       ...
       <div className="d-flex justify-content-around align-items-center" >
        ...
        <h5 style={{fontSize:"12px",color:'#2980b9',textAlign:'center'}} >Narayana junior College</h5>   
        </div>
        <div>
        <h5 className="d-flex mb-2 " style={{fontSize:"17px",color:'#2980b9'}} ><div><FontAwesomeIcon className="mr-2" icon="calendar" /></div>TimeLine</h5>
        <h5 style={{fontSize:"15px",color:'#2980b9',textAlign:'center'}}>2016 ~ 2018</h5>   
      </div>   
       ...
       <div className="d-flex justify-content-around align-items-center" >
        <div className="py-3">
        <h5 className="d-flex mb-2 " style={{fontSize:"17px",color:'#2980b9'}} ><div><FontAwesomeIcon className="mr-2" icon="school" /></div>College</h5>
        <h5 style={{fontSize:"12px",color:'#2980b9',textAlign:'center'}} >Aurora’s Technological & Research Institute</h5>   
        </div>
        <div>
        <h5 className="d-flex mb-2 " style={{fontSize:"17px",color:'#2980b9'}} ><div><FontAwesomeIcon className="mr-2" icon="calendar" /></div>TimeLine</h5>
        <h5 style={{fontSize:"15px",color:'#2980b9',textAlign:'center'}}>2018 ~ 2022</h5>   
      </div>   
