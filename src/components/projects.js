...
export default function Projects() {
    const[project,setproject]=useState([
        {
            ...
            type:'nodejs/Express',
            des:'The main motto of this project is to fetch the API called weather API and show details in the front end I used the node JS to complete this project and deployed in heroku for live.',
            filter:false,
            cat:'web app'
        },
        {
            ...
            des:'Display a UI with 2 select lists for countries and 2 inputs for amount and Fetch exchange rates from API (https://api.exchangerate-api.com) and Display the values for both countries simultaneously Update values on amount change ',
            filter:false,
            cat:'web app'
        },
        {
            ...
            type:'javascript/html/css',
            des:'The main motto of this project is to track the expenses of daily , the data which has entered by user has been Persist to local storage. Display transaction items in DOM and Show balance, expense and income totals . Delete items from DOM',
            filter:false,
            cat:'web app'
        },
        {
          name:'Personal portfolio',
           type:'React',
           des:'This is the Self Developed personal website build with React.js',
           filter:false,
           cat:'web app'
        },
        {
    ...
    return (
        ...
        <div className="container d-flex   justify-content-md-center mb-lg-3 ">
          ...
          <Button className="text-uppercase font-weight-normal"  onClick={()=>handleClick('desktop')} style={{color:val2==true?'#333':'#ccc',border:'none',fontWeight:'bold',background:'transparent' , borderRadius:'5px'}}></Button>
