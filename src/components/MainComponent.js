...
const Example = (props) => {
  ...
  return (
    <div style={{fontSize:"15px"}}>
      ...
      <NavbarBrand  onClick={()=>scroll.scrollToTop()} className="mr-auto" ><div style={{color:'black',fontFamily:"Optima, sans-serif",paddingLeft:'2rem',fontWeight:'bold',fontSize:'2rem',cursor:'pointer'}}>PortFolio</div></NavbarBrand>
